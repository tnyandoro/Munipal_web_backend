    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CommunityServiceUpdates",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UpdateType = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityServiceUpdates", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AssignedArea = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeterNumber = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UtilityType = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UtilityType = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MonthlyFixedRate = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    MinReading = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    MaxReading = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_Meters_ElectricityMeterId",
                        column: x => x.ElectricityMeterId,
                        principalTable: "Meters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Customers_Meters_WaterMeterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeterReadings_MeterReaders_CapturedById",
                        column: x => x.CapturedById,
                        principalTable: "MeterReaders",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_ElectricityMeterId",
                table: "Customers",
                column: "ElectricityMeterId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_WaterMeterId",
                table: "Customers",
                column: "WaterMeterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeterReadings_CapturedById",
                table: "MeterReadings",
                column: "CapturedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tariffs_UtilityType_ActiveFrom",
                table: "Tariffs",
                columns: new[] { "UtilityType", "ActiveFrom" },
                unique: true);
